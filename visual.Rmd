...
The number of HIV diagnoses is apparently higher among male subgroups than female in all neighborhoods. Beford Stuyvesant - Crown Heights have the highest total HIV diagnoses and highest female HIV diagnoses cases. Chelsea - Clinton ranks first in male HIV diagnoses. Bayside - Little Neck has lowest number of HIV diagnoses for both male and female.
...
As is shown in the barchart above, in every age range, HIV incidence rate in male is significantly higher than that in female population. The potential explanation could be the gender differences with respect to HIV/AIDS depend on patterns of disease transmission. For example, men who have sex with men (MSM) takes up a large porpotion in existing HIV cases because unprotected anal intercourse are more likely to transmit HIV. Most infections occurred in adults aged 20 to 29 years, and the incidence porpotion declines as the increase of age.
...
However, if we compare the plot of HIV Incidence with the plot of HIV related death rate, we will notice that although the HIV incidence in male is much higher than female, the HIV related death rate in women is higher than that of men in some race, like White and Latino/Hispanic. We can draw the conclusion that women infected with HIV disease are more vulnerable than men with HIV disease. Other possible explanation could be male are more likely to get access to the HIV treatment than women, reflecting the gender inequality of social status.
